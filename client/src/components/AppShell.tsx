...
import {
  LayoutDashboard, Building2, Users, ShieldCheck, Wrench, Plug, PoundSterling, Menu, X, Send, FileText, Landmark,
} from "lucide-react";
...
const NAV = [
  ...
  { href: "/reconciliation", label: "Reconciliation", icon: Landmark, match: (p: string) => p.startsWith("/reconciliation") },
];
